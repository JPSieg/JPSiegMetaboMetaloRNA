...
vector.files = paste("Figures/Figure_2_Table_3_SI_table_5_helix_stability/Fluorescence_data", list.files("Figures/Figure_2_Table_3_SI_table_5_helix_stability/Fluorescence_data"), sep = "/")
...
list.fit[[1]] = meltR.F(list.df[[1]],
                        ...
                        file_path = "Figures/Figure_2_Table_3_SI_table_5_helix_stability/Fit_data/",
                        file_prefix = vector.prefixes[1],
                        Save_results = "all")
list.K.range[[1]] = c(1, 150)

list.fit[[2]] = meltR.F(list.df[[2]],
                        Kd_error_quantile = 0.75,
                        Kd_range = c(50, 750),
                        file_path = "Figures/Figure_2_Table_3_SI_table_5_helix_stability/Fit_data/",
...
for (i in 1:length(vector.files)){
  ...
  list.df.Ks[[i]]$In_Kd_range = TRUE
  list.df.Ks[[i]]$In_Kd_range[which(list.df.Ks[[i]]$Kd < list.K.range[[i]][1])] = FALSE
  list.df.Ks[[i]]$In_Kd_range[which(list.df.Ks[[i]]$Kd > list.K.range[[i]][2])] = FALSE
}
...
write.csv(df.Tms, "Figures/Figure_2_Table_3_SI_table_5_helix_stability/Fits_summary_Tms.csv", row.names = FALSE)
write.csv(df.vh, "Figures/Figure_2_Table_3_SI_table_5_helix_stability/Fits_summary_vh.csv", row.names = FALSE)
write.csv(df.Ks, "Figures/Figure_2_Table_3_SI_table_5_helix_stability/Fits_summary_Ks.csv", row.names = FALSE)
...
ggsave("Figures/Figure_2_Table_3_SI_table_5_helix_stability/SI_figure_x_Vant_hoff_plots.png",
       height = 2, scale = 2)
