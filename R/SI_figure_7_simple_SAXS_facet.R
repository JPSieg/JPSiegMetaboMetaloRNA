...
df$Condition = factor(df$Condition,
                      levels = c("2 mM Mg2+", "Eco80", "NTPCM", "WMCM", "25 mM Mg2+"))
...
SI_Figure_XBCDEFG = plot_grid(Pr.plot, Figure_C, Figure_D, Figure_E, Figure_F, Figure_G,
                           ncol = 1,
                           labels = c("B", "C (2 mM free)", "D (Eco80)", "E (NTPCM)", "F (WMCM)", "G (25 mM free Mg2+)"),
                           rel_heights = c(1.2, 1, 1, 1, 1, 1),
                           label_size = 20)

SI_figure_X = plot_grid(Kratky.plot,
                        SI_Figure_XBCDEFG,
                        nrow = 1,
                        rel_widths= c(1, 1.25))
...
ggsave("Figures/SI_figure_7_simple_SAXS/SI_figure_x_faceted.svg", SI_figure_X, scale = 3, height = 5.5, width = 4)
