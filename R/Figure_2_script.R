...
Figure_2ABCDEFG = plot_grid(PNG.2A, Figure_2BCD, Figure_2EFG, labels = c("A"), ncol = 1, rel_heights = c(2,1,1), label_size = 20)


ggsave("Figures/Figure_2/Figure_2.png", Figure_2ABCDEFG, width = 7, height = 9, scale = 2)
